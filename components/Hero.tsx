...
>
  <div className="inline-block rounded-2xl bg-slate-950/40 backdrop-blur-sm p-4 md:p-6">
    ...
    <p className="mt-4 text-slate-100/95 max-w-prose drop-shadow">
    ...
    <div className="mt-6 flex flex-wrap gap-3">
      ...
      <a href="#tools" className="px-4 py-2 rounded-xl border border-slate-200/40 hover:border-slate-200/70 backdrop-blur">Tools</a>
